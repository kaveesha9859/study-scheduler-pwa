...
/**
 * Register the service worker, with optional onUpdate / onSuccess callbacks.
...
export function register(config) {
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    ...
    if (publicUrl.origin !== window.location.origin) {
      // Public URL is on a different origin; SW won't work.
      return;
    }
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        // Log to dev console that SW is serving from cache-first.
        ...
        // Not localhost: just register SW
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              // Content is cached for offline use; execute onSuccess callback
